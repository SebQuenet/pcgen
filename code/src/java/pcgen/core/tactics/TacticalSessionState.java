 ...
 */
public record TacticalSessionState(int damageTaken, Map<String, Integer> resourcesSpent)
{
	...
	{
		return new TacticalSessionState(0, Map.of());
	}
	...
	{
		return damageTaken == 0 && resourcesSpent.values().stream().allMatch(count -> count == 0);
	}
}
